 ...
 * calls as it reads a file containing the animation and builds a model.
 * It is parameterized over the actual model type.
 * It is used to construct a complete model from a given data file.
 */
public interface TweenModelBuilder<T> {
  ...
  /**
   * IMove the specified shape to the given position during the given time
   * interval.
   *
   * @param name      the unique name of the {@code Actor} to be moved
   ...
   *
   * @param name      the unique name of the {@code Actor} whose color is to be changed
   ...
   *
   * @param name      the unique name of the {@code Actor} who will be scaled
   * @param fromSx    the starting width of the {@code Actor}
   * @param fromSy    the starting height of the {@code Actor}
   * @param toSx      the new width of the {@code Actor}
   * @param toSy      the new height of the {@code Actor}
   * @param startTime the time when the transformation will begin
   * @param endTime   the time when the transformation will end
   * @return reference to {@code this}, for chaining
   */
